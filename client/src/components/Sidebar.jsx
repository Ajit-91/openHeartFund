...
const Icon = ({ styles, name, imgUrl, isActive, disabled, handleClick }) => (
  <div className={`w-[48px] h-[48px] rounded-[10px] ${isActive && isActive === name && 'bg-[#f0f2f5] dark:bg-[#2c2f32]'} flex justify-center items-center ${!disabled && 'cursor-pointer'} ${styles}`} onClick={handleClick}>
    {!isActive ? (
    ...
    <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh]">
      ...
      <div className="flex-1 flex flex-col justify-between items-center bg-[#ffffff] dark:bg-[#1c1c24] rounded-[20px] w-[76px] py-4 mt-12">
        ...
        <Icon 
          ...
          styles="bg-[#ffffff] dark:bg-[#1c1c24]" imgUrl={theme === "light" ? moon : sun} />
      </div>
    </div>
  )
}
